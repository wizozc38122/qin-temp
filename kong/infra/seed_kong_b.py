...
KONG_ADMIN_URL = "http://localhost:29001" # Kong B Port
...
def main():
    print("==================================================")
    print(f"Seeding Kong-B (Comparison Target)")
    print("==================================================")
    ...
    # 只有 B 有
    svc_member_qin = create_service("member-service-qin", "http://k8s.com/member")
    if svc_member_qin:
        create_route("member-service-qin", "route-member-qin", ["/member"], hosts=["qin.com"])
    ...
    # 只有 B 有
    svc_api_c = create_service("order-api-c", "http://k8s.com/order/apiC")
    if svc_api_c:
        create_route("order-api-c", "route-api-c", ["/order/apiC"], hosts=["qin.com"])
